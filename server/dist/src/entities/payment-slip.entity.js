...
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int),
    (0, typeorm_1.Column)({ type: 'int2', nullable: true, default: 1 }),
    __metadata("design:type", Number)
], PaymentSlip.prototype, "mjesec", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int),
    (0, typeorm_1.Column)({ type: 'int', nullable: true, default: new Date().getFullYear() }),
    __metadata("design:type", Number)
], PaymentSlip.prototype, "godina", void 0);
__decorate([
    (0, graphql_1.Field)(() => customer_entity_1.Customer),
    (0, typeorm_1.ManyToOne)(() => customer_entity_1.Customer, entity => entity.paymentSlips, {
        onDelete: 'CASCADE',
    }),
...
__decorate([
    (0, graphql_1.Field)(() => isp_entity_1.Isp),
    (0, typeorm_1.ManyToOne)(() => isp_entity_1.Isp, entity => entity.paymentSlips, {
        onDelete: 'CASCADE',
    }),
    (0, typeorm_1.JoinColumn)({ name: 'isp_id', referencedColumnName: 'id' }),
