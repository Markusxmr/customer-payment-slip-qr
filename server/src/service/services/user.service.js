...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.create = function (createUserDto) {
        var item = new user_entity_1.User();
        return this.userRepository.save(__assign(__assign({}, item), createUserDto));
    };
    UserService.prototype.createMany = function (createUserDtos) {
        var items = [];
        for (var _i = 0, createUserDtos_1 = createUserDtos; _i < createUserDtos_1.length; _i++) {
            var item = createUserDtos_1[_i];
            items.push(item);
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.userRepository.save(__assign(__assign({}, item), updateUserDto))];
                }
            });
        });
    };
    UserService.prototype.removeAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository
                            .createQueryBuilder('users')["delete"]()
                            .from(user_entity_1.User)
                            .execute()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, new typeorm_1.DeleteResult()];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!item)
                            throw new common_1.NotFoundException();
                        return [2 /*return*/, this.userRepository["delete"](item.id)];
                }
            });
        });
    };
