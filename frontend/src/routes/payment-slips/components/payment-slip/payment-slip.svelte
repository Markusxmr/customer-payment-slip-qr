		...
		{#if loaded}
			...
			<fieldset class="fieldset-brojke">
				...
				<div>
					...
					<textarea
						class="form-field form-field--opis {!model.opis_placanja ? 'form-field-invalid' : ''}"
			...
			<div>
				...
				<fieldset class="fieldset-potvrda">
					...
					<div class="potvrda-field potvrda-field--model-i-poziv-na-broj-platitelja" />
					<div class="potvrda-field potvrda-field--iban-primatelja" />
					<div class="potvrda-field potvrda-field--model-i-poziv-na-broj-primatelja" />
					<div class="potvrda-field potvrda-field--opis-placanja" />
				</fieldset>
				{#if !printing}
					<fieldset style="text-align: center">
						<button class="btn btn-primary btn-sm" name="print" on:click={submitUpdatePaymentSlip}
							>Spremi nalog</button
						>
						<button class="btn btn-warning btn-sm" on:click={decoder}>Dekodirano</button>
						<button
							class="btn btn-danger btn-sm"
							on:click={() => submitDeletePaymentSlip(model?.id)}>Izbriši</button
						>
					</fieldset>
					<br />
				{/if}
...
<div class="container">
	{#if showDecoder}
		<textarea bind:value={hub3_code} style="width: 100%; height: 295px; font-size: 0.9rem" />
	{/if}
</div>
