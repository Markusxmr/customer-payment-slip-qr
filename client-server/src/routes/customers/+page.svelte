<script lang="ts">
  ...
  function actionRenderer(instance: any, td: any, row: any, col: any, prop: any, value: any, cellProperties: any) {
    ...
    Handsontable.dom.removeEvent(viewBtn, "mousedown", () => goto(`/payment-slips/customer/${stringifiedValue}`));
    Handsontable.dom.addEvent(viewBtn, "mousedown", (e: any) => goto(`/payment-slips/customer/${stringifiedValue}`));
